...
describe Board do
  describe "#find_moves" do
    ...
    it "returns moves for a piece" do
      ...
      expect(full_board.find_moves(piece1_bishop)).to eql([])

      expect(full_board.find_moves(piece2_bishop)).to eql([])
  ...
  describe "#in_check?" do
    ...
    it "returns true if curr team is in check" do
      ...
      check_test_board.move_piece_to(bishop, check_test_board.find_moves(bishop), 4)  
    ...
    it "returns true if curr team is in check" do
      ...
      check_test_board.move_piece_to(king, check_test_board.find_moves(king), 1)
    ...
    it "returns true if curr team is in check" do
      ...
      check_test_board.move_piece_to(queen, check_test_board.find_moves(queen), 8)
